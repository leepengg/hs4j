...
public interface HSClient {
    ...
    /**
     * Open a IndexSession with a filter columns,please reuse IndexSession as
     * much as possible.
     * 
     * @param indexId
     * @param dbname
     ...
     */
    public IndexSession openIndexSession(int indexId, String dbname, String tableName, String indexName,
            String[] columns, String[] fcolumns) throws InterruptedException, TimeoutException, HandlerSocketException;
     ...
     */
    public IndexSession openIndexSession(int indexId, String dbname, String tableName, String indexName,
            String[] columns) throws InterruptedException, TimeoutException, HandlerSocketException;
    ...
    /**
     * Open a IndexSession with a auto-generated indexId and a filter columns,
     * please reuse IndexSession as much as possible.
     * 
     * @param dbname
     * @param tableName
     * @param indexName
     ...
     */
    public IndexSession openIndexSession(String dbname, String tableName, String indexName, String[] columns,
            String[] fcolumns) throws InterruptedException, TimeoutException, HandlerSocketException;
     ...
     * @throws HandlerSocketException
     */
    public ResultSet find(int indexId, String[] keys, FindOperator operator, int limit, int offset, Filter[] filters)
            throws InterruptedException, TimeoutException, HandlerSocketException;
     ...
     * @throws HandlerSocketException
     */
    public ResultSet find(int indexId, String[] values, FindOperator operator, int limit, int offset)
            throws InterruptedException, TimeoutException, HandlerSocketException;
     ...
     * @throws HandlerSocketException
     */
    public ResultSet find(int indexId, String[] keys) throws InterruptedException, TimeoutException,
     ...
     * @throws HandlerSocketException
     */
    public int delete(int indexId, String[] keys, FindOperator operator) throws InterruptedException, TimeoutException,
            HandlerSocketException;
     ...
     * commands.Default is 2.5f*cpus.
     */
    public static final int DEFAULT_READ_THREAD_COUNT = (int) (2.5 * Runtime.getRuntime().availableProcessors());
